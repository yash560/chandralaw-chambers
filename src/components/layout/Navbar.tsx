...
import { Scale, Phone, Calendar, Sun, Moon, Menu, X, User, Search } from 'lucide-react';
          ...
          <div className="flex items-center justify-between h-16 sm:h-20 gap-2">
            ...
            <div className="flex items-center space-x-2 shrink-0">
              ...
              <button
                ...
                className="flex items-center space-x-2 px-3 py-2 rounded-xl bg-card border border-border text-xs text-muted-foreground hover:text-foreground hover:bg-muted"
                title="Search (Cmd+K)"
              >
                <Search className="w-3.5 h-3.5 text-blue-600" />
                <span className="hidden xl:inline text-[11px]">Search...</span>
                <kbd className="hidden sm:inline-flex items-center px-1.5 py-0.5 rounded bg-muted text-[10px] font-mono border border-border">
                  ⌘K
                </kbd>
              </button>
